                    ...
                    successedBlock:^(NSDictionary *retDic){
                        ...
                        [HTTP_MANAGER getContact:m_searchBar.text
                                  ...
                                  successedBlock:^(NSDictionary *retDic){
                                      ...
                                      ADTGropuInfo *preGroupData  = [[ADTGropuInfo alloc]init];
                                      preGroupData.isContactView = YES;
                                      preGroupData.m_strDepId = self.m_currentGroup ? self.m_currentGroup.m_strDepId : [LoginUserUtil deptId];
                                      preGroupData.m_strDeptName = @"..返回上级";
                                      [arr addObject:preGroupData];
                                      ...
                                      [HTTP_MANAGER getDepInfo:self.m_depId
                                                successedBlock:^(NSDictionary *succeedResult) {
                                                    ...
                                                    preGroupData.m_strParentId = preGroupData.m_strParentId = ret[@"result"][@"parentId"];
