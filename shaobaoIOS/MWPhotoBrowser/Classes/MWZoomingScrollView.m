...
@interface MWZoomingScrollView ()<UIAlertViewDelegate> {
...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
        ...
        UIColor *bgColor = [UIColor whiteColor];
         if(_photoBrowser.isPresent) bgColor = [UIColor blackColor];
...
- (CGFloat)initialZoomScaleWithMinScale {
    ...
    if (_photoImageView && _photoBrowser.zoomPhotosToFill) {
        ...
        CGSize tosize = [_photoImageView.image resizeToSize:CGSizeMake(SCREEN_WIDTH, SCREEN_HEIGHT)];
        zoomScale = MIN(tosize.width/imageSize.width, tosize.height/imageSize.height);
    }
    return zoomScale;
}
...
- (void)setMaxMinZoomScalesForCurrentBounds {
    ...
    // Initial zoom
    int scale =  [self initialZoomScaleWithMinScale];
...
// TODO:  单击隐藏
    [_photoBrowser performSelector:@selector(dismiss) withObject:nil];
