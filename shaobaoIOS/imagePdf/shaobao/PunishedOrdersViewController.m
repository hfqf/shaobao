//
//  PunishedOrdersViewController.m
//  shaobao
//
...
#import "PunishedOrdersViewController.h"
#import "FindTableViewCell.h"
#import "FindServiceInfoViewController.h"
#import "FindSenderInfoViewController.h"
@interface PunishedOrdersViewController ()<UITableViewDelegate,UITableViewDataSource,FindTableViewCellDelegate>

@end

@implementation PunishedOrdersViewController
- (id)init
{
...
- (void)requestData:(BOOL)isRefresh
{
    ...
    [HTTP_MANAGER findGetMySendHelpList:helpId
                               pageSize:@"20"
